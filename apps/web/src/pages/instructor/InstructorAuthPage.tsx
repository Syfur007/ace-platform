...
export function InstructorAuthPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      setAccessToken('instructor', res.accessToken)
      navigate('/instructor')
    } catch (e) {
  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-slate-600">Instructor accounts are provisioned via backend bootstrap env vars in dev.</p>
      </header>
